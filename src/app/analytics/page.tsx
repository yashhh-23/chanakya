...
export default function AnalyticsPage() {
  ...
  // CSV Export Functionality (FR-8.5)
  const handleExportCSV = () => {
    ...
    const rows = data.vehicleReports.map((v) => [
      ...
      v.totalOperationalCost.toFixed(2),
      v.revenue.toFixed(2),
      v.roi,
    ])
    ...
    link.setAttribute(
      'download',
      `transitops_fleet_analytics_${new Date().toISOString().slice(0, 10)}.csv`
    )
  ...
  return (
    <div className="flex min-h-screen bg-zinc-950 text-zinc-100 font-sans">
      <Sidebar currentRole="Financial Analyst" />

      <div className="flex-1 flex flex-col min-w-0 overflow-y-auto">
        <Topbar
          title="Reports & Financial Analytics"
          subtitle="Fleet-wide operational efficiency, ROI analysis, expenditure breakdowns, and CSV export"
